  ...
  switch (selector) {
    UINT16 TPMU_SYM_KEY_BITS_Marshal(TPMU_SYM_KEY_BITS * source, BYTE * *buffer,
      ...
      switch (selector) {
        ...
        TPM_RC TPM_KEY_BITS_Unmarshal(TPM_KEY_BITS * target, BYTE * *buffer,
                                      INT32 * size) {
        ...
        TPM_RC TPMI_AES_KEY_BITS_Unmarshal(TPMI_AES_KEY_BITS * target,
          ...
          size_t length =
              sizeof(supported_values) / sizeof(supported_values[0]);
          size_t i;
...
#ifdef TPM_ALG_SM4
        case TPM_ALG_SM4:
          return TPMI_SM4_KEY_BITS_Marshal((TPMI_SM4_KEY_BITS*)&source->SM4,
                                           buffer, size);
#endif
#ifdef TPM_ALG_AES
        case TPM_ALG_AES:
          return TPMI_AES_KEY_BITS_Marshal((TPMI_AES_KEY_BITS*)&source->aes,
                                           buffer, size);
#endif
#ifdef TPM_ALG_XOR
        case TPM_ALG_XOR:
          return TPMI_ALG_HASH_Marshal((TPMI_ALG_HASH*)&source->xor_, buffer,
                                       size);
#endif
      }
      return 0;
...
#ifdef TPM_ALG_SM4
        case TPM_ALG_SM4:
          return TPMI_ALG_SYM_MODE_Marshal((TPMI_ALG_SYM_MODE*)&source->SM4,
                                           buffer, size);
#endif
#ifdef TPM_ALG_AES
        case TPM_ALG_AES:
          return TPMI_ALG_SYM_MODE_Marshal((TPMI_ALG_SYM_MODE*)&source->aes,
                                           buffer, size);
#endif
#ifdef TPM_ALG_XOR
        case TPM_ALG_XOR:
    ...
    UINT16 TPMT_SYM_DEF_OBJECT_Marshal(TPMT_SYM_DEF_OBJECT * source,
      ...
      UINT16 total_size = 0;
      total_size +=
          TPMI_ALG_SYM_OBJECT_Marshal(&source->algorithm, buffer, size);
    ...
    TPM_RC TPMT_SYM_DEF_OBJECT_Unmarshal(TPMT_SYM_DEF_OBJECT * target,
      ...
      result = TPMU_SYM_MODE_Unmarshal(&target->mode, buffer, size,
                                       target->algorithm);
      if (result != TPM_RC_SUCCESS) {
        return result;
      }
    ...
    UINT16 TPMU_ASYM_SCHEME_Marshal(TPMU_ASYM_SCHEME * source, BYTE * *buffer,
      ...
      switch (selector) {
        ...
        TPM_RC TPMS_SCHEME_SIGHASH_Unmarshal(TPMS_SCHEME_SIGHASH * target,
          ...
          TPM_RC result;
          result =
              TPMI_ALG_HASH_Unmarshal(&target->hashAlg, buffer, size, FALSE);
          if (result != TPM_RC_SUCCESS) {
            return result;
          }
          return TPM_RC_SUCCESS;
        ...
        UINT16 TPMS_SCHEME_RSAPSS_Marshal(TPMS_SCHEME_RSAPSS * source,
                                          BYTE * *buffer, INT32 * size) {
          return TPMS_SCHEME_SIGHASH_Marshal(source, buffer, size);
        }

        TPM_RC TPMS_SCHEME_RSAPSS_Unmarshal(TPMS_SCHEME_RSAPSS * target,
                                            BYTE * *buffer, INT32 * size) {
          return TPMS_SCHEME_SIGHASH_Unmarshal(target, buffer, size);
        }
        ...
        TPM_RC TPMS_SCHEME_ECDH_Unmarshal(TPMS_SCHEME_ECDH * target,
          ...
          TPM_RC result;
          result =
              TPMI_ALG_HASH_Unmarshal(&target->hashAlg, buffer, size, TRUE);
          if (result != TPM_RC_SUCCESS) {
            return result;
          }
          return TPM_RC_SUCCESS;
        ...
        UINT16 TPMS_SCHEME_SM2_Marshal(TPMS_SCHEME_SM2 * source, BYTE * *buffer,
                                       INT32 * size) {
          return TPMS_SCHEME_SIGHASH_Marshal(source, buffer, size);
        }
...
#ifdef TPM_ALG_ECDH
        case TPM_ALG_ECDH:
          return TPMS_SCHEME_ECDH_Marshal((TPMS_SCHEME_ECDH*)&source->ecdh,
                                          buffer, size);
#endif
#ifdef TPM_ALG_OAEP
        case TPM_ALG_OAEP:
          return TPMS_SCHEME_OAEP_Marshal((TPMS_SCHEME_OAEP*)&source->oaep,
                                          buffer, size);
#endif
#ifdef TPM_ALG_RSAPSS
        case TPM_ALG_RSAPSS:
          return TPMS_SCHEME_RSAPSS_Marshal(
              (TPMS_SCHEME_RSAPSS*)&source->rsapss, buffer, size);
#endif
#ifdef TPM_ALG_ECDAA
        case TPM_ALG_ECDAA:
          return TPMS_SCHEME_ECDAA_Marshal((TPMS_SCHEME_ECDAA*)&source->ecdaa,
                                           buffer, size);
#endif
#ifdef TPM_ALG_RSASSA
        case TPM_ALG_RSASSA:
          return TPMS_SCHEME_RSASSA_Marshal(
              (TPMS_SCHEME_RSASSA*)&source->rsassa, buffer, size);
#endif
#ifdef TPM_ALG_SM2
        case TPM_ALG_SM2:
          return TPMS_SCHEME_SM2_Marshal((TPMS_SCHEME_SM2*)&source->sm2, buffer,
                                         size);
#endif
#ifdef TPM_ALG_ECDSA
        case TPM_ALG_ECDSA:
    ...
    TPM_RC TPMU_ASYM_SCHEME_Unmarshal(TPMU_ASYM_SCHEME * target, BYTE * *buffer,
                                      INT32 * size, UINT32 selector) {
      switch (selector) {
#ifdef TPM_ALG_RSAES
        case TPM_ALG_RSAES:
...
#ifdef TPM_ALG_OAEP
        case TPM_ALG_OAEP:
          return TPMS_SCHEME_OAEP_Unmarshal((TPMS_SCHEME_OAEP*)&target->oaep,
                                            buffer, size);
#endif
#ifdef TPM_ALG_RSAPSS
        case TPM_ALG_RSAPSS:
          return TPMS_SCHEME_RSAPSS_Unmarshal(
              (TPMS_SCHEME_RSAPSS*)&target->rsapss, buffer, size);
#endif
#ifdef TPM_ALG_ECDAA
        case TPM_ALG_ECDAA:
          return TPMS_SCHEME_ECDAA_Unmarshal((TPMS_SCHEME_ECDAA*)&target->ecdaa,
                                             buffer, size);
#endif
#ifdef TPM_ALG_RSASSA
        case TPM_ALG_RSASSA:
          return TPMS_SCHEME_RSASSA_Unmarshal(
              (TPMS_SCHEME_RSASSA*)&target->rsassa, buffer, size);
#endif
#ifdef TPM_ALG_SM2
        case TPM_ALG_SM2:
          return TPMS_SCHEME_SM2_Unmarshal((TPMS_SCHEME_SM2*)&target->sm2,
                                           buffer, size);
#endif
#ifdef TPM_ALG_ECDSA
        case TPM_ALG_ECDSA:
    ...
    UINT16 TPMT_RSA_SCHEME_Marshal(TPMT_RSA_SCHEME * source, BYTE * *buffer,
                                   INT32 * size) {
      UINT16 total_size = 0;
      total_size += TPMI_ALG_RSA_SCHEME_Marshal(&source->scheme, buffer, size);
      total_size += TPMU_ASYM_SCHEME_Marshal(&source->details, buffer, size,
                                             source->scheme);
      return total_size;
    }

    TPM_RC TPMT_RSA_SCHEME_Unmarshal(TPMT_RSA_SCHEME * target, BYTE * *buffer,
                                     INT32 * size) {
      TPM_RC result;
      result =
          TPMI_ALG_RSA_SCHEME_Unmarshal(&target->scheme, buffer, size, TRUE);
      if (result != TPM_RC_SUCCESS) {
        return result;
      }
    ...
    UINT16 TPMI_RSA_KEY_BITS_Marshal(TPMI_RSA_KEY_BITS * source, BYTE * *buffer,
                                     INT32 * size) {
      return TPM_KEY_BITS_Marshal(source, buffer, size);
    }
    ...
    UINT16 TPMS_RSA_PARMS_Marshal(TPMS_RSA_PARMS * source, BYTE * *buffer,
                                  INT32 * size) {
      UINT16 total_size = 0;
      total_size +=
          TPMT_SYM_DEF_OBJECT_Marshal(&source->symmetric, buffer, size);
    ...
    UINT16 TPMT_ASYM_SCHEME_Marshal(TPMT_ASYM_SCHEME * source, BYTE * *buffer,
                                    INT32 * size) {
      UINT16 total_size = 0;
    ...
    TPM_RC TPMT_ASYM_SCHEME_Unmarshal(TPMT_ASYM_SCHEME * target, BYTE * *buffer,
      ...
      TPM_RC result;
      result =
          TPMI_ALG_ASYM_SCHEME_Unmarshal(&target->scheme, buffer, size, TRUE);
      if (result != TPM_RC_SUCCESS) {
        return result;
      }
      result = TPMU_ASYM_SCHEME_Unmarshal(&target->details, buffer, size,
    ...
    UINT16 TPMS_ASYM_PARMS_Marshal(TPMS_ASYM_PARMS * source, BYTE * *buffer,
                                   INT32 * size) {
      UINT16 total_size = 0;
      total_size +=
          TPMT_SYM_DEF_OBJECT_Marshal(&source->symmetric, buffer, size);
    ...
    TPM_RC TPMS_ASYM_PARMS_Unmarshal(TPMS_ASYM_PARMS * target, BYTE * *buffer,
                                     INT32 * size) {
      TPM_RC result;
      result = TPMT_SYM_DEF_OBJECT_Unmarshal(&target->symmetric, buffer, size);
      if (result != TPM_RC_SUCCESS) {
    ...
    UINT16 TPMI_ALG_KDF_Marshal(TPMI_ALG_KDF * source, BYTE * *buffer,
                                INT32 * size) {
      return TPM_ALG_ID_Marshal(source, buffer, size);
    }

    TPM_RC TPMI_ALG_KDF_Unmarshal(TPMI_ALG_KDF * target, BYTE * *buffer,
                                  INT32 * size, BOOL allow_conditional_value) {
      TPM_RC result;
      BOOL has_valid_value = FALSE;
      result = TPM_ALG_ID_Unmarshal(target, buffer, size);
      if (result != TPM_RC_SUCCESS) {
    ...
    UINT16 TPMU_KDF_SCHEME_Marshal(TPMU_KDF_SCHEME * source, BYTE * *buffer,
                                   INT32 * size, UINT32 selector) {
      switch (selector) {
        UINT16 TPMS_SCHEME_KDF1_SP800_108_Marshal(
            TPMS_SCHEME_KDF1_SP800_108 * source, BYTE * *buffer, INT32 * size) {
          UINT16 total_size = 0;
          total_size += TPMI_ALG_HASH_Marshal(&source->hashAlg, buffer, size);
          return total_size;
        }

        TPM_RC TPMS_SCHEME_KDF1_SP800_108_Unmarshal(
            TPMS_SCHEME_KDF1_SP800_108 * target, BYTE * *buffer, INT32 * size) {
          TPM_RC result;
          result =
              TPMI_ALG_HASH_Unmarshal(&target->hashAlg, buffer, size, FALSE);
          if (result != TPM_RC_SUCCESS) {
        ...
        UINT16 TPMS_SCHEME_KDF1_SP800_56a_Marshal(
            TPMS_SCHEME_KDF1_SP800_56a * source, BYTE * *buffer, INT32 * size) {
          UINT16 total_size = 0;
          total_size += TPMI_ALG_HASH_Marshal(&source->hashAlg, buffer, size);
          return total_size;
        }
        ...
        TPM_RC TPMS_SCHEME_KDF1_SP800_56a_Unmarshal(
            TPMS_SCHEME_KDF1_SP800_56a * target, BYTE * *buffer, INT32 * size) {
          TPM_RC result;
          result =
              TPMI_ALG_HASH_Unmarshal(&target->hashAlg, buffer, size, FALSE);
          if (result != TPM_RC_SUCCESS) {
        ...
        case TPM_ALG_KDF1_SP800_56a:
          return TPMS_SCHEME_KDF1_SP800_56a_Marshal(
              (TPMS_SCHEME_KDF1_SP800_56a*)&source->kdf1_SP800_56a, buffer,
              size);
#endif
#ifdef TPM_ALG_MGF1
        case TPM_ALG_MGF1:
          return TPMS_SCHEME_MGF1_Marshal((TPMS_SCHEME_MGF1*)&source->mgf1,
                                          buffer, size);
#endif
#ifdef TPM_ALG_KDF1_SP800_108
        case TPM_ALG_KDF1_SP800_108:
          return TPMS_SCHEME_KDF1_SP800_108_Marshal(
              (TPMS_SCHEME_KDF1_SP800_108*)&source->kdf1_sp800_108, buffer,
              size);
#endif
#ifdef TPM_ALG_KDF2
        case TPM_ALG_KDF2:
          return TPMS_SCHEME_KDF2_Marshal((TPMS_SCHEME_KDF2*)&source->kdf2,
                                          buffer, size);
#endif
#ifdef TPM_ALG_NULL
        case TPM_ALG_NULL:
    ...
    TPM_RC TPMU_KDF_SCHEME_Unmarshal(TPMU_KDF_SCHEME * target, BYTE * *buffer,
                                     INT32 * size, UINT32 selector) {
      switch (selector) {
#ifdef TPM_ALG_KDF1_SP800_56a
        case TPM_ALG_KDF1_SP800_56a:
          return TPMS_SCHEME_KDF1_SP800_56a_Unmarshal(
              (TPMS_SCHEME_KDF1_SP800_56a*)&target->kdf1_SP800_56a, buffer,
              size);
#endif
#ifdef TPM_ALG_MGF1
        case TPM_ALG_MGF1:
        ...
        case TPM_ALG_KDF1_SP800_108:
          return TPMS_SCHEME_KDF1_SP800_108_Unmarshal(
              (TPMS_SCHEME_KDF1_SP800_108*)&target->kdf1_sp800_108, buffer,
              size);
#endif
#ifdef TPM_ALG_KDF2
        case TPM_ALG_KDF2:
    ...
    UINT16 TPMT_KDF_SCHEME_Marshal(TPMT_KDF_SCHEME * source, BYTE * *buffer,
                                   INT32 * size) {
      UINT16 total_size = 0;
      total_size += TPMI_ALG_KDF_Marshal(&source->scheme, buffer, size);
      total_size += TPMU_KDF_SCHEME_Marshal(&source->details, buffer, size,
                                            source->scheme);
      return total_size;
    }
    ...
    TPM_RC TPMT_KDF_SCHEME_Unmarshal(TPMT_KDF_SCHEME * target, BYTE * *buffer,
      ...
      result = TPMU_KDF_SCHEME_Unmarshal(&target->details, buffer, size,
                                         target->scheme);
      if (result != TPM_RC_SUCCESS) {
        return result;
      }
...
#ifdef TPM_ALG_HMAC
        case TPM_ALG_HMAC:
          return TPMS_SCHEME_HMAC_Marshal((TPMS_SCHEME_HMAC*)&source->hmac,
                                          buffer, size);
#endif
#ifdef TPM_ALG_ECSCHNORR
        case TPM_ALG_ECSCHNORR:
    ...
    TPM_RC TPMU_SIG_SCHEME_Unmarshal(TPMU_SIG_SCHEME * target, BYTE * *buffer,
                                     INT32 * size, UINT32 selector) {
      switch (selector) {
#ifdef TPM_ALG_HMAC
        case TPM_ALG_HMAC:
    ...
    UINT16 TPMT_ECC_SCHEME_Marshal(TPMT_ECC_SCHEME * source, BYTE * *buffer,
                                   INT32 * size) {
      UINT16 total_size = 0;
      total_size += TPMI_ALG_ECC_SCHEME_Marshal(&source->scheme, buffer, size);
      total_size += TPMU_SIG_SCHEME_Marshal(&source->details, buffer, size,
                                            source->scheme);
      return total_size;
    }

    TPM_RC TPMT_ECC_SCHEME_Unmarshal(TPMT_ECC_SCHEME * target, BYTE * *buffer,
                                     INT32 * size) {
      TPM_RC result;
      result =
          TPMI_ALG_ECC_SCHEME_Unmarshal(&target->scheme, buffer, size, TRUE);
      if (result != TPM_RC_SUCCESS) {
        return result;
      }
      result = TPMU_SIG_SCHEME_Unmarshal(&target->details, buffer, size,
                                         target->scheme);
      if (result != TPM_RC_SUCCESS) {
        return result;
      }
    ...
    UINT16 TPM_ECC_CURVE_Marshal(TPM_ECC_CURVE * source, BYTE * *buffer,
                                 INT32 * size) {
      return UINT16_Marshal(source, buffer, size);
    }

    TPM_RC TPM_ECC_CURVE_Unmarshal(TPM_ECC_CURVE * target, BYTE * *buffer,
                                   INT32 * size) {
      TPM_RC result;
      result = UINT16_Unmarshal(target, buffer, size);
      if (result != TPM_RC_SUCCESS) {
    ...
    UINT16 TPMI_ECC_CURVE_Marshal(TPMI_ECC_CURVE * source, BYTE * *buffer,
                                  INT32 * size) {
    ...
    UINT16 TPMS_ECC_PARMS_Marshal(TPMS_ECC_PARMS * source, BYTE * *buffer,
                                  INT32 * size) {
      UINT16 total_size = 0;
      total_size +=
          TPMT_SYM_DEF_OBJECT_Marshal(&source->symmetric, buffer, size);
    ...
    TPM_RC TPMS_ECC_PARMS_Unmarshal(TPMS_ECC_PARMS * target, BYTE * *buffer,
                                    INT32 * size) {
      TPM_RC result;
      result = TPMT_SYM_DEF_OBJECT_Unmarshal(&target->symmetric, buffer, size);
      if (result != TPM_RC_SUCCESS) {
    ...
    TPM_RC TPMI_ALG_KEYEDHASH_SCHEME_Unmarshal(
        TPMI_ALG_KEYEDHASH_SCHEME * target, BYTE * *buffer, INT32 * size,
        BOOL allow_conditional_value) {
      TPM_RC result;
      BOOL has_valid_value = FALSE;
      result = TPM_ALG_ID_Unmarshal(target, buffer, size);
    ...
    UINT16 TPMU_SCHEME_KEYEDHASH_Marshal(TPMU_SCHEME_KEYEDHASH * source,
                                         ...
                                         UINT32 selector) {
      switch (selector) {
        UINT16 TPMS_SCHEME_XOR_Marshal(TPMS_SCHEME_XOR * source, BYTE * *buffer,
                                       INT32 * size) {
          UINT16 total_size = 0;
          total_size += TPMI_ALG_HASH_Marshal(&source->hashAlg, buffer, size);
...
#ifdef TPM_ALG_XOR
        case TPM_ALG_XOR:
          return TPMS_SCHEME_XOR_Marshal((TPMS_SCHEME_XOR*)&source->xor_,
                                         buffer, size);
#endif
      }
      return 0;
...
#ifdef TPM_ALG_XOR
        case TPM_ALG_XOR:
          return TPMS_SCHEME_XOR_Unmarshal((TPMS_SCHEME_XOR*)&target->xor_,
                                           buffer, size);
#endif
      }
      return TPM_RC_SELECTOR;
    ...
    UINT16 TPMT_KEYEDHASH_SCHEME_Marshal(TPMT_KEYEDHASH_SCHEME * source,
      ...
      total_size += TPMU_SCHEME_KEYEDHASH_Marshal(&source->details, buffer,
                                                  size, source->scheme);
      return total_size;
    }
    ...
    TPM_RC TPMT_KEYEDHASH_SCHEME_Unmarshal(TPMT_KEYEDHASH_SCHEME * target,
                                           BYTE * *buffer, INT32 * size) {
      TPM_RC result;
      result = TPMI_ALG_KEYEDHASH_SCHEME_Unmarshal(&target->scheme, buffer,
                                                   size, TRUE);
      if (result != TPM_RC_SUCCESS) {
        return result;
      }
    ...
    UINT16 TPMS_KEYEDHASH_PARMS_Marshal(TPMS_KEYEDHASH_PARMS * source,
      ...
      UINT16 total_size = 0;
      total_size +=
          TPMT_KEYEDHASH_SCHEME_Marshal(&source->scheme, buffer, size);
      return total_size;
    }
...
UINT16 TPMU_SENSITIVE_COMPOSITE_Marshal(TPMU_SENSITIVE_COMPOSITE* source,
  ...
  switch (selector) {
    ...
    UINT16 TPM2B_SYM_KEY_Marshal(TPM2B_SYM_KEY * source, BYTE * *buffer,
                                 INT32 * size) {
      UINT16 total_size = 0;
      INT32 i;
      total_size += UINT16_Marshal(&source->t.size, buffer, size);
...
UINT16 TPMU_ATTEST_Marshal(TPMU_ATTEST* source,
  ...
  switch (selector) {
    ...
    UINT16 TPMS_QUOTE_INFO_Marshal(TPMS_QUOTE_INFO * source, BYTE * *buffer,
      ...
      UINT16 total_size = 0;
      total_size +=
          TPML_PCR_SELECTION_Marshal(&source->pcrSelect, buffer, size);
      total_size += TPM2B_DIGEST_Marshal(&source->pcrDigest, buffer, size);
      return total_size;
    }

    TPM_RC TPMS_QUOTE_INFO_Unmarshal(TPMS_QUOTE_INFO * target, BYTE * *buffer,
                                     INT32 * size) {
      TPM_RC result;
      result = TPML_PCR_SELECTION_Unmarshal(&target->pcrSelect, buffer, size);
      if (result != TPM_RC_SUCCESS) {
    ...
    UINT16 TPMS_CERTIFY_INFO_Marshal(TPMS_CERTIFY_INFO * source, BYTE * *buffer,
                                     INT32 * size) {
      UINT16 total_size = 0;
    ...
    UINT16 TPMS_SESSION_AUDIT_INFO_Marshal(TPMS_SESSION_AUDIT_INFO * source,
      ...
      UINT16 total_size = 0;
      total_size +=
          TPMI_YES_NO_Marshal(&source->exclusiveSession, buffer, size);
    ...
    TPM_RC TPMS_TIME_INFO_Unmarshal(TPMS_TIME_INFO * target, BYTE * *buffer,
                                    INT32 * size) {
      TPM_RC result;
    ...
    UINT16 TPMS_NV_CERTIFY_INFO_Marshal(TPMS_NV_CERTIFY_INFO * source,
      ...
      total_size +=
          TPM2B_MAX_NV_BUFFER_Marshal(&source->nvContents, buffer, size);
      return total_size;
    }
  ...
  switch (selector) {
    ...
    case TPM_ALG_ECSCHNORR:
      return TPMS_SIGNATURE_ECDSA_Marshal(
          (TPMS_SIGNATURE_ECDSA*)&source->ecschnorr, buffer, size);
#endif
#ifdef TPM_ALG_RSAPSS
    case TPM_ALG_RSAPSS:
...
#ifdef TPM_ALG_ECDAA
    case TPM_ALG_ECDAA:
      return TPMS_SIGNATURE_ECDSA_Marshal((TPMS_SIGNATURE_ECDSA*)&source->ecdaa,
                                          buffer, size);
#endif
#ifdef TPM_ALG_RSASSA
    case TPM_ALG_RSASSA:
...
#ifdef TPM_ALG_SM2
    case TPM_ALG_SM2:
      return TPMS_SIGNATURE_ECDSA_Marshal((TPMS_SIGNATURE_ECDSA*)&source->sm2,
                                          buffer, size);
#endif
#ifdef TPM_ALG_ECDSA
    case TPM_ALG_ECDSA:
  ...
  switch (selector) {
    ...
    case TPM_ALG_ECSCHNORR:
      return TPMS_SIGNATURE_ECDSA_Unmarshal(
          (TPMS_SIGNATURE_ECDSA*)&target->ecschnorr, buffer, size);
#endif
#ifdef TPM_ALG_RSAPSS
    case TPM_ALG_RSAPSS:
    ...
    case TPM_ALG_ECDAA:
      return TPMS_SIGNATURE_ECDSA_Unmarshal(
          (TPMS_SIGNATURE_ECDSA*)&target->ecdaa, buffer, size);
#endif
#ifdef TPM_ALG_RSASSA
    case TPM_ALG_RSASSA:
...
#ifdef TPM_ALG_SM2
    case TPM_ALG_SM2:
      return TPMS_SIGNATURE_ECDSA_Unmarshal((TPMS_SIGNATURE_ECDSA*)&target->sm2,
                                            buffer, size);
#endif
#ifdef TPM_ALG_ECDSA
    case TPM_ALG_ECDSA:
