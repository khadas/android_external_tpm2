...
class TestParser(unittest.TestCase):
  ...
  def testStructureParser(self):
    ...
    self.assertEqual(types[1].new_type, 'att_type')
    self.assertEqual(types[1].reserved[0], '4_7')
    self.assertEqual(types[1].reserved[1], '9')
    self.assertEqual(types[2].old_type, 'base_type')
    self.assertEqual(types[2].new_type, 'const_type')
    self.assertEqual(types[2].valid_values[0], 'const_name')
    self.assertEqual(types[2].error_code, 'return_name')
